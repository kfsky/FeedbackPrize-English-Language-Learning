...
class CFG:
    name = "exp054"
    explain = "yevheniimaslov/deberta-v3-base-cola, LLRD 0.7, reinit=1 Attention Pooling, exp050=LLRD=0.8"
    wandb = True
    send_slack = False
    send_notion = True
    competition = "FB3"
    ...
    model = "yevheniimaslov/deberta-v3-base-cola"
    ...
    batch_size=8 # https://www.kaggle.com/c/nbme-score-clinical-patient-notes/discussion/308298
    fc_dropout=0.2
    max_len=2048
    weight_decay=0.01
    #target_size=3
